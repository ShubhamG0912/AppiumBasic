...
public class Bitbar_Main {
	    AndroidDriver driver;
	  @Test(dataProvider = "dp")
	  public void f(String name) throws Exception {
	      
	      Bitbar_Pom obj = new Bitbar_Pom(driver);
	      obj.selectRadio();
	      obj.typeName(name);
	      obj.clickSubmit();
	      Thread.sleep(2000);
	      ...
	      if(obj.isDisplayed()) {
	          ...
	          File dfile = new File("D:\\Eclipse_training\\Java2024_Appium\\bitbidar.png");
...
//	      File f1 = new File("D:\\Eclipse_training\\Java2024_Appium\\Bitbar.xlsx");
